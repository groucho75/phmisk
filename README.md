...
The `app/cache` folder contains the files generated by the template engine (note: *cache folder must have permissions at least 755, maybe 775 or 777*). It could be a good idea move the cache folder outside/above the site foot.
...
The `app/libraries` folder contains optional libraries. You can add here your custom classes, made by you or simply not available on remote repositories: they will be autoloaded.

<?php if ( ! defined('ENV')) exit('No direct script access allowed'); ?><!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>	
		...
		<link rel="apple-touch-icon-precomposed" href="ui/apple-touch-iphone.png" />
		...
		<script>window.jQuery || document.write('<script src="ui/js/vendor/jquery-1.11.0.min.js"><\/script>')</script>

		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="<?php if(CURRENT_URI == '/') echo 'active'?>"><a href="<?=BASE_URL?>">Home</a></li>
					<li class="<?php if(CURRENT_URI == '/readme') echo 'active'?>"><a href="<?=BASE_URL?>readme">Readme</a></li>					
					<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="<?php if(CURRENT_URI == '/test') echo 'active'?>"><a href="<?=BASE_URL?>test">$demo->test()</a></li>
